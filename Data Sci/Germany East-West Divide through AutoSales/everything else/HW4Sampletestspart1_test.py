...
class HW4Sampletests_part1(unittest.TestCase):
    ...
    def test_counttomarkNEW(self):
        ...
        self.assertTrue(opPop()==5 and opPop()==5 and opPop()=='-mark-' and opPop()==5 and opPop()==2)    
    ...
    def test_getintervalNEW(self):
        #[3 5 5 True 4] 3 get
        opPush([4,5,3,5,5,True,4])
        opPush(2)
        opPush(10)
        getinterval()
        self.assertEqual(opPop(),[3,5,5,True,4])         
        self.assertTrue(len(opstack)==0)      
    ...
    def test_putNEW(self):
        ...
        opPush(20)
        put()
        self.assertEqual(opPop(),[3,4,20,6,7,8])      
        self.assertTrue(len(opstack)==0)
    ...
    def test_putintervalNEW(self):
        opPush([0,1,3,5,5,True,4])
        dup() # we duplicate the array reference
        opPush(2)
        opPush([4,5,1,0,1,1,1,1]) 
        putinterval()
        self.assertEqual(opPop(),[0,1,4,5,1,0,1,1,1,1])
        self.assertTrue(len(opstack)==0)
    ...
    # #  Also make sure that the opstack content is : ['/x', 10] <- this would be an incorrect restoration of the stack (should be [10,"/x"])
